...
BOOL CWSockChkApp::InitInstance()         //переопределение метода CWinApp::InitInstance()
{
	...
	*/
    ...
    pFrame->Create(AfxRegisterWndClass(NULL,LoadCursor(IDC_ARROW),(HBRUSH)COLOR_BACKGROUND,NULL),
...
pFrame->MessageBox("Program for Windows Socket test\n\nCopyright 2001\n\nSmetanin Ivan Valerevich","About",MB_OK);	
}
